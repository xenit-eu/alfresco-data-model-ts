 ...
 * Both are represented by the same structure, distinguished by the value of {@link AssociationDefinition.childAssociation}.
 *
...
export default interface AssociationDefinition
     ...
     *
     * If true, data updates that would violate the requirement from {@link AssociationDefinition.sourceMandatory} will be rejected.
     */
     ...
     *
     * If true, data updates that would violate the requirement from {@link AssociationDefinition.targetMandatory} will be rejected.
     */
